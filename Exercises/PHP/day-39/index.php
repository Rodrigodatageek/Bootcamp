...
class Chihuahua extends Dog
{
    public function __construct($name, $natural_enemies = [])
    {
        $this->position = "standing";
        $this->name = $name;
        $this->natural_enemies = array_merge(["King Kong"], $natural_enemies);
    }
}
...
<?php $second_dog = new Chihuahua('Bingo',['King Kong']); ?>
 
<p>Chihuahua's name is <?= $second_dog->readDogTag() ?></p>
<p>Chihuahua goes <?= $second_dog->barkAt('King Kong') ?> whatever you can think of</p>
<p>Chihuahua is <?= "CREATE A CHIHUAHUA IN A WAY THAT IT STANDS AT THE BEGINNING AND ECHO ITS POSITION" ?></p>
<?php
    // echo "<p>".$second_dog->sit()."</p>"; - uncomment after your chihuahua is created
?>
<p>Chihuahua is <?= "MAKE SURE CHIHUAHUA DOESN'T ACTUALLY SIT AFTER IT'S INSTRUCTED TO AND ECHO ITS POSITION" ?></p>